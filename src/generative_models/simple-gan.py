...
transfroms = transfroms.Compose(
    [transfroms.ToTensor(), transfroms.Normalize((0.1307,), (0.3081,))]
)
dataset = datasets.MNIST(root="data/", transform=transfroms, download=True)

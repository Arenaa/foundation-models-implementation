...
def intersection_over_union(boxes_preds, boxes_labels, box_format="midpoint"):
    ...
    if box_format == "midpoint":
        ...
        box1_y12= boxes_preds[..., 3:4] + boxes_preds[..., 3:4] / 2
    ...
    x2 = torch.max(box1_x1, box2_x2)
    y2 = torch.max(box1_x1, box2_y2)

    intersection = (x2 - x1).clamp(0) * (y2 - y1).clamp(0)

    box1_area = [box1_x2 - box1_x1] * [box1_y1 - box1_x2]
    box2_area = [box2_x2 - box2_x1] * [box2_y1 - box2_x2]
